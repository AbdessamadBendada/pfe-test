    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1 pt-3">
          <!-- Dashboard -->
          <li class="menu-item <?php if ($data['page_title'] == "Accueil") {
                                  echo "active";
                                } ?> ">
          ...
          <!-- Layouts -->
          <li class="menu-item  pt-2 <?php if ($data['page_title'] == "Demande de Conge" || $data['page_title'] == "Demande d'absence" || $data['page_title'] == "Demande attestation de travaille" || $data['page_title'] == "Demande Reafectation" || $data['page_title'] == "Demande attestation de salaire" || $data['page_title'] == "Demande changement nomination") {
                                        echo "active open";
                                      } ?> ">
            ...
            <ul class="menu-sub ">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Demande de Conge") {
                                      echo "active";
                                    } ?>">
                <a href="<?= ROOT ?>demande_conge" class="menu-link">
                  <div>Demande Congé</div>
                </a>
              </li>
              <li class="menu-item <?php if ($data['page_title'] == "Demande d'absence") {
                                      echo "active";
                                    } ?>">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Demande attestation de travaille") {
                                      echo "active";
                                    } ?>">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Demande attestation de salaire") {
                                      echo "active";
                                    } ?>">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Demande changement nomination") {
                                      echo "active";
                                    } ?>">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Demande Reafectation") {
                                      echo "active";
                                    } ?>">
                <a href="<?= ROOT ?>demande_reafectation" class="menu-link">
                  <div>Demande de Réaffectation</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="menu-item pt-2 <?php if ($data['page_title'] == "Informations Personnels" || $data['page_title'] == "Bulletin de Paie") {
                                      echo "active open";
                                    } ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
              <li class="menu-item <?php if ($data['page_title'] == "Informations Personnels") {
                                      echo "active";
                                    } ?>">
              ...
              <li class="menu-item <?php if ($data['page_title'] == "Bulletin de Paie") {
                                      echo "active";
                                    } ?>">
          ...
          <li class="menu-item pt-2  <?php if ($data['page_title'] == "Visite de Medecin de Travail" || $data['page_title'] == "Conceil Discipline") {
                                        echo "active open";
                                      } ?>">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
              <li class="menu-item <?php if ($data['page_title'] == "Visite de Medecin de Travail") {
                                      echo "active ";
                                    } ?>">
                <a href="<?= ROOT ?>visite_medecin" class="menu-link" target="">
                  <div data-i18n="Basic">Visite médecin de travail</div>
                </a>
              </li>
              <li class="menu-item <?php if ($data['page_title'] == "Conceil Discipline") {
                                      echo "active ";
                                    } ?>">
                <a href="<?= ROOT ?>conceil_discipline" class="menu-link" target="">
                  <div data-i18n="Basic">Conseil discipline</div>
                </a>
              </li>
          ...
          <li class="menu-item pt-2 <?php if ($data['page_title'] == "Note de Procedure") {
                                      echo "active ";
                                    } ?>">
            <a href="<?= ROOT ?>note_procedure" class="menu-link">
              <i class="menu-icon tf-icons bx bx-detail"></i>

              <div data-i18n="Basic">Notes de Procédure</div>
            </a>
          </li>
          ...
          ?>
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Espace Gestion</span>
            </li>
            <li class="menu-item  pt-2 <?php if ($data['page_title'] == "Ajouter Employee" || $data['page_title'] == "Modifier Employee" || $data['page_title'] == "Modifier Information de paie" || $data['page_title'] == "Supprimer Employee") {
                                          echo "active open";
                                        } ?> ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub ">
                <li class="menu-item <?php if ($data['page_title'] == "Ajouter Employee") {
                                        echo "active ";
                                      } ?>">
                ...
                <li class="menu-item <?php if ($data['page_title'] == "Modifier Employee") {
                                        echo "active";
                                      } ?>">
                ...
                <li class="menu-item <?php if ($data['page_title'] == "Supprimer Employee") {
                                        echo "active";
                                      } ?>">
                  <a href="<?= ROOT ?>supprimer_employee" class="menu-link">
                    <div>Supprimer Employé</div>
                  </a>
                </li>
                <li class="menu-item <?php if ($data['page_title'] == "Modifier Information de paie") {
                                        echo "active";
                                      } ?>">
            ...
            <li class="menu-item  pt-2 <?php if ($data['page_title'] == "Demandes des absences" || $data['page_title'] == "Gestion changement des nominations" || $data['page_title'] == "Gestion des conges" || $data['page_title'] == "Gestion des reafectations") {
                                          echo "active open";
                                        } ?> ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub ">
                <li class="menu-item <?php if ($data['page_title'] == "Gestion des conges") {
                                        echo "active ";
                                      } ?>">
                  <a href="<?= ROOT ?>gestion_conge" class="menu-link">
                    <div>Gestion des congés</div>
                  </a>
                </li>
                <li class="menu-item <?php if ($data['page_title'] == "Demandes des absences") {
                                        echo "active";
                                      } ?>">
                ...
                <li class="menu-item <?php if ($data['page_title'] == "Gestion changement des nominations") {
                                        echo "active";
                                      } ?>">
                ...
                <li class="menu-item <?php if ($data['page_title'] == "Gestion des reafectations") {
                                        echo "active";
                                      } ?>">
                  <a href="<?= ROOT ?>gestion_reafectation" class="menu-link">
                    <div>Demandes de réaffectation</div>
                  </a>
                </li>

              </ul>
            </li>
            <li class="menu-item  pt-2 <?php if ($data['page_title'] == "Ajouter Département" || $data['page_title'] == "Supprimer Département" || $data['page_title'] == "" || $data['page_title'] == "") {
                                          echo "active open";
                                        } ?> ">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub ">
                <li class="menu-item <?php if ($data['page_title'] == "Ajouter Département") {
                                        echo "active ";
                                      } ?>">
                ...
                <li class="menu-item <?php if ($data['page_title'] == "Supprimer Département") {
                                        echo "active";
                                      } ?>">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          ...
                          <small class="text-muted"><?php if ($_SESSION['role'] == 2) {
                                                      echo "Admin";
